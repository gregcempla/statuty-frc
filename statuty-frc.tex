...
\lett{2} Do Federacji mogą indywidualnie dołączyć inni wierni, dopuszczeni przez dyrektorów sekcji, zgodnie z postanowieniami przepisów własnych, które zostały zatwierdzone przez Konwencję Generalną Federacji, \mbox{a mianowicie}:
...
\lett{7} Dążymy do oddawania chwały Bogu i uobecniania Królestwa Chrystusa w sercach ludzi i społeczeństwie dzięki osobistemu uświęceniu \mbox{w okolicznościach} życia, w jakich powołuje nas Bóg oraz poprzez indywidualne i wspólnotowe działania apostolskie.
...
\lett{18} Kochamy duchową rodzinę Regnum Christi jako Boży dar pomagający nam spotkać Chrystusa, pozwalający wzrastać z Nim \mbox{w przyjaźni} i bliskości i być Jego apostołem we wspólnocie z innymi.
...
\lett{24} Budujemy nasze życie wewnętrzne i apostolskie na cnotach teologalnych, żyjąc jaśniejącą, twórczą wiarą, niezachwianą, radosną nadzieją i powszechną, hojną miłością do innych. 
...
\lett{27} Zjednoczeni przez Ojca, Syna i Ducha Świętego w jedną, wielką rodzinę Kościoła i złączeni wspólnym powołaniem Regnum Christi umacniamy świadomość bycia jednym ciałem, zjednoczeniem serc, ideałów, zamiarów i wysiłków. Promujemy jedność i współpracę świadomi, że jedność jest misyjna, a misja służy jedności.
...
\lett{53} \S{}1. Federacja Regnum Christi jako międzynarodowa instytucja kościelna posiada trzystopniową strukturę: generalną, terytorialną \mbox{i lokalną}.
...
\lett{59} \S{}1. Stowarzyszeni wierni, którzy są częścią organów kierownictwa na szczeblu generalnym lub terytorialnym Federacji, zgodnie \mbox{z przepisami} Federacji, mają prawo głosu doradczego.
...
\lett{65} \S{}1. Federacja zwołuje Konwencję Generalną co sześć lat, zgodnie \mbox{z zasadami} określonymi w odpowiednich przepisach.
...
\lett{69} W przypadku zwyczajniej Konwencji Generalnej z rocznym, \mbox{a w przypadku} nadzwyczajnej Konwencji Generalnej z odpowiednim wyprzedzeniem, Kolegium Generalne ogłasza członkom stowarzyszonych instytucji oraz stowarzyszonym wiernym datę jej celebracji.
...
\lett{71} \S{}1.  Kolegium Generalne odpowiada za oficjalne wezwanie na zwyczajną Konwencję Generalną. Odbywa się ono z trzymiesięcznym wyprzedzeniem, z wysłaniem listy uczestników oraz wskazaniem daty \mbox{i miejsca} rozpoczęcia Konwencji.
...
\lett{73} Wszystkie kwestie analizowane i omawiane na Konwencji Generalnej muszą być rozstrzygane w atmosferze modlitwy, rozeznania \mbox{i dialogu} pełnego szacunku.
...
\lett{77} Aby Kolegium było prawomocnie ustanowione, potrzebny jest udział trzech członków, o ile dwoje z nich nie jest równocześnie członkami innego kolegium. Ponadto należy zapobiegać podejmowaniu decyzji bez konsultacji ze stowarzyszonymi wiernymi, którzy wchodzą \mbox{w skład} Kolegium.
...
\filbreak\lett{86} \S{}1. Administratorowi generalnemu podlegają kwestie bieżącego zarządzania dobrami Federacji, zaś on sam, zgodnie z prawem powszechnym, prawem własnym Federacji oraz przepisami prawa cywilnego, podlega władzy Kolegium Generalnego.
...
\lett{100} Na mienie Federacji składają się te wszystkie dobra ruchome \mbox{i nieruchome}, aktywa finansowe i ekonomiczne, które prawomocnie i zgodnie z prawem Federacji przeznaczone są do zagwarantowania jej bezpieczeństwa ekonomicznego w zależności od jej potrzeb.
...
\filbreak\ssec{Niektóre kryteria zarządzania dobrami}
...
\filbreak\ssec{Darowizny obciążone zobowiązaniami}
...
\lett{112} \S{}1. Najwyższy organ instytucji stowarzyszonej, po wysłuchaniu opinii innych zrzeszonych podmiotów, może wnioskować \mbox{u Stolicy} Apostolskiej o odłączenie od Federacji.
...
\lett{114} Konwencja Generalna, motywowana poważnymi przesłankami, po uprzedniej zgodzie zwierzchnich organów instytucji stowarzyszonych, może za pomocą dwóch trzecich głosów członków instytucji stowarzyszonych wnioskować u Stolicy Apostolskiej o wydalenie jednej \mbox{z nich}.
...
\lett{115} \S{}1. Rozwiązanie Federacji musi zostać zatwierdzone przez Stolicę Apostolską\footnote{CIC, kanon 582} na prośbę Konwencji Generalnej Federacji \mbox{i zwierzchnich} organów władzy instytucji stowarzyszonych.
